export function showTaskCompletedScreen(app) {
  app.hideAllScreens();
  document.getElementById('taskCompletedScreen').classList.add('active');
  renderTaskCompletedScreen(app);
}

export function renderTaskCompletedScreen(app) {
  ...
  if (app.gameState.isUnanimous) {
    document.getElementById('finalValueLabel').textContent = 'Unanimité atteinte';
    document.getElementById('finalValueDisplay').textContent = app.gameState.finalValue;
  } else if (app.gameMode === 'median') {
    document.getElementById('finalValueLabel').textContent = 'Médiane calculée';
    document.getElementById('finalValueDisplay').textContent = app.gameState.medianValue;
  } else {
